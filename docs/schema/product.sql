...
(
    ...
    `status`    tinyint unsigned NOT NULL DEFAULT 0 COMMENT '状态。0：隐藏；1：展示',
...
(
    ...
    `brand_id`             bigint unsigned NOT NULL COMMENT '商品品牌ID',
    ...
    `promotion_limit`      int unsigned NOT NULL DEFAULT 0 COMMENT '活动限购数量',
    `promotion_start_time` int unsigned NOT NULL DEFAULT DEFAULT 0 COMMENT '促销开始时间',
    `promotion_end_time`   int unsigned NOT NULL DEFAULT DEFAULT 0 COMMENT '促销结束时间',
    ...
    `publish_status`       tinyint unsigned NOT NULL DEFAULT 0 COMMENT '发布状态 0：未发布；1：发布',
    `new_status`           tinyint unsigned NOT NULL DEFAULT 0 COMMENT '新品状态 0：非新品；1：新品',
...
(
    `id`          bigint unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `category_id` bigint unsigned NOT NULL DEFAULT 0 COMMENT '商品类型ID',
    `brand_id`    bigint unsigned NOT NULL DEFAULT 0 COMMENT '商品品牌ID',
...
(
    `id`                            bigint unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `product_attribute_category_id` bigint unsigned NOT NULL DEFAULT 0 COMMENT '商品属性分类 ID',
    `name`                          varchar(64)   NOT NULL COMMENT '名称',
    `select_type`                   tinyint unsigned NOT NULL COMMENT '熟悉选择类型。1：唯一；2：单选；3：多选',
    `option_status`                 tinyint unsigned NOT NULL COMMENT '录入方式 1：手动录入 2：列表中选取',
...
(
    ...
    `product_sku_id`   bigint unsigned NOT NULL DEFAULT 0 COMMENT '商品SKU ID',
    `customer_user_id` bigint unsigned NOT NULL DEFAULT 0 COMMENT '用户ID',
    ...
    `star`             tinyint unsigned NOT NULL DEFAULT 0 COMMENT '评星数。1-5',
...
(
    `id`               bigint unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `type`             tinyint unsigned NOT NULL DEFAULT 0 COMMENT '评论人员类型。 1：会员 2：管理员',
    `comment_id`       bigint unsigned NOT NULL DEFAULT 0 COMMENT '评论id',
    `customer_user_id` bigint unsigned NOT NULL DEFAULT 0 COMMENT '用户ID',
    `append_flag`      tinyint unsigned NOT NULL DEFAULT 0 COMMENT '追加标识 0：否 1：是',
    `member_nick_name` varchar(100)  NOT NULL COMMENT '用户昵称',
    `member_icon`      varchar(255)  NOT NULL COMMENT '用户头像',
    `content`          varchar(1000) NOT NULL DEFAULT '' COMMENT '评论',
    `created_at`       timestamp     NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `is_delete`        tinyint unsigned NOT NULL DEFAULT 0 COMMENT '删除时间',
    PRIMARY KEY (`id`),
    KEY                `idx_comment_id` (`comment_id`, `is_delete`)
